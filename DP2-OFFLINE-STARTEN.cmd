...
start "" powershell -NoProfile -WindowStyle Hidden -Command "Start-Sleep -Seconds 2; Start-Process 'http://127.0.0.1:8765/index.html?build=216&offline=1'"
echo KC DP2 Build 216 wird lokal gestartet.
