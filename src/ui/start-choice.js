(function(){
  ...
  function launcherHtml(){
    ...
    return `<div class="kc-start-choice-shell"><section class="kc-start-choice-card" aria-labelledby="kcStartChoiceTitle">
      ...
      <div class="kc-start-choice-grid">
        ...
        ${edit?'<button type="button" class="kc-start-choice-option" id="kcChoicePaper"><span class="kc-start-choice-icon">▤</span><span class="kc-start-choice-copy"><b>Bedarfsmatrix als PDF</b><span>Grundbedarf, Wetter, Bühnenprogramm, Empfehlung und Soll für alle Tage drucken.</span></span></button>':''}
      </div>
  ...
  function showLauncher(){
    ...
    if($('kcChoicePaper'))$('kcChoicePaper').onclick=()=>K.demandView.print(K.days);
