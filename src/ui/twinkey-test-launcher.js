...
function open(){
 ...
 box.innerHTML='<header style="display:flex;flex-wrap:wrap;align-items:center;gap:10px;padding:12px;background:#fff4d9;border-bottom:1px solid #d6bd82;color:#332717"><strong>Twinkey-Test · Build 222 · nur Beispieldaten</strong><button id="twinkeyTestClose" type="button" style="margin-left:auto;min-height:44px;padding:8px 16px">Zurück zur Adminansicht</button></header><iframe title="Mitgliederführung mit Twinkey testen" sandbox="allow-scripts allow-modals" style="flex:1;width:100%;border:0;background:white"></iframe>';
 const frame=box.querySelector('iframe');frame.src=new URL('twinkey-test.html?build=222',document.baseURI).href;
