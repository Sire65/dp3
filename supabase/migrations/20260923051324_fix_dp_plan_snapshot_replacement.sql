...
begin
  ...
  -- p_rows ist immer der vollstaendige aktuell sichtbare Sollplan-Schnappschuss.
  -- Deshalb muessen ALLE bisher publizierten Zeilen derselben Veranstaltung,
  -- die nicht mehr enthalten sind, entfernt werden. Das gilt auch fuer [].
