...
const required=['Wunsch','Soll','Ist geprüft','Ist aus Buchungen','Tageszeit','Internes Dokument','pseudoName','.original','K.exports.printHtml','Personenkonto drucken','qrSvg','qrByPerson','Marianne Bierkämper'];
...
if(!html.includes('person-account-print.js?v=0.20.0-b243-print-legibility')||!/KC_DP_BUILD=(?:21[7-9]|2[2-9]\d|[3-9]\d{2,})/.test(html))throw new Error('Build-Integration fehlt');
