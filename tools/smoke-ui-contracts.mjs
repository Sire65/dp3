...
assert(personalized.includes("fetch('templates/KC_DP2_Wunschzeiten_Vorlage_Weihnachtsmarkt_2026_V6_VHB.xlsx'")&&personalized.includes('JSZip.loadAsync')&&personalized.includes('QR-Identifikation')&&personalized.includes('profile.profileId'), 'Excel-Download muss die Originalmatrix mit Person, Profil-ID und QR-Blatt personalisieren');
