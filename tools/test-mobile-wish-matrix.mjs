...
try{
 ...
 await page.locator('[data-field=start]').fill('11:00');await page.locator('[data-field=end]').fill('21:00');
 await page.locator('[data-add="preferred"]').click();
 await page.locator('[data-mm-row="1"] [data-field=start]').fill('12:00');await page.locator('[data-mm-row="1"] [data-field=end]').fill('22:00');
 ...
 await page.locator('[data-mm-row="1"] [data-field=end]').fill('18:00');
 await page.locator('[data-add="unavailable"]').click();
 await page.locator('[data-mm-row="2"] [data-field=start]').fill('19:00');await page.locator('[data-mm-row="2"] [data-field=end]').fill('20:00');
 await page.screenshot({path:path.join(out,'handy-tagesmatrix.png'),fullPage:true});
 await page.locator('#mmSave').click();assert.equal(await page.evaluate(()=>KCDP.mobileWishMatrix.rows('me').length),3);
 ...
 await page.locator('[data-mm-row="1"] [data-field=end]').fill('17:00');await page.locator('#mmSave').click();
