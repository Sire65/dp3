...
try{
 ...
 assert(await page.locator('#swDayBlock').isVisible());await page.locator('#swNext').click();assert(await page.locator('[data-list=times]').first().isVisible());assert(await page.locator('#swTeamToggle').isVisible());
