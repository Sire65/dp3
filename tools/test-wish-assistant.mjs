...
try{
 ...
 await page.evaluate(()=>KCDP.wishAssistant.open('2026-12-05'));await page.locator('[data-choice=status][data-value=reserve]').click();await page.locator('#waNext').click();await page.locator('#waWhole').click();await page.locator('#waNext').click();assert.match(await page.locator('.wa-question h1').innerText(),/nicht kannst/);
