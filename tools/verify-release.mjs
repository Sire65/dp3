...
if(Number(manifest.build)!==233)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b233'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
