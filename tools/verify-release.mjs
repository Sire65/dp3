...
if(Number(manifest.build)!==230)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b230'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
