...
if(Number(manifest.build)!==243)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b243'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
