...
if(Number(manifest.build)!==226)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b226'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
