...
if(Number(manifest.build)!==238)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b238'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
