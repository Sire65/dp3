...
if(Number(manifest.build)!==218)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b218'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
