...
if(Number(manifest.build)!==241)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b241'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
