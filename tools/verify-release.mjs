...
if(Number(manifest.build)!==232)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b232'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
