...
if(Number(manifest.build)!==231)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b231'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
