...
if(Number(manifest.build)!==242)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b242'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
