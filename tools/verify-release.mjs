...
if(Number(manifest.build)!==236)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b236'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
