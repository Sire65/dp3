...
if(Number(manifest.build)!==216)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b216'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
