...
if(Number(manifest.build)!==214)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b214'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
