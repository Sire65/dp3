...
if(Number(manifest.build)!==211)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b211'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
