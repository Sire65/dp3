...
if(Number(manifest.build)!==212)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b212'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
