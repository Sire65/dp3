...
if(Number(manifest.build)!==189)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b189'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
