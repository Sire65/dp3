...
if(Number(manifest.build)!==240)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b240'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
