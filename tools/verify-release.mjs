...
if(Number(manifest.build)!==213)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b213'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
