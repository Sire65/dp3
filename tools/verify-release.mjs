...
if(Number(manifest.build)!==87)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b87'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
