...
if(Number(manifest.build)!==228)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b228'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
