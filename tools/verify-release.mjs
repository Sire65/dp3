...
if(Number(manifest.build)!==227)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b227'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
