...
if(Number(manifest.build)!==203)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b203'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
