...
if(Number(manifest.build)!==190)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b190'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
