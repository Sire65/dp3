...
if(Number(manifest.build)!==235)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b235'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
