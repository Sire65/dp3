...
if(Number(manifest.build)!==210)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b210'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
