...
if(Number(manifest.build)!==225)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b225'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
