...
if(Number(manifest.build)!==209)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b209'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
