...
if(Number(manifest.build)!==224)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b224'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
