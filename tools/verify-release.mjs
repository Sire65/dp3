...
if(Number(manifest.build)!==234)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b234'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
