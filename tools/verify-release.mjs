...
if(Number(manifest.build)!==191)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b191'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
