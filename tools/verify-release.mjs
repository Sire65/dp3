...
if(Number(manifest.build)!==229)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b229'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
