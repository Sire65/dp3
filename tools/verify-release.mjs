...
if(Number(manifest.build)!==204)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b204'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
