...
if(Number(manifest.build)!==219)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b219'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
