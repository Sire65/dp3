...
if(Number(manifest.build)!==220)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b220'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
