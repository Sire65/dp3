...
if(Number(manifest.build)!==85)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b85'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
