...
if(Number(manifest.build)!==222)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b222'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
