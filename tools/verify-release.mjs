...
if(Number(manifest.build)!==221)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b221'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
