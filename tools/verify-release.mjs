...
if(Number(manifest.build)!==223)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b223'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
