...
if(Number(manifest.build)!==237)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b237'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
