...
if(Number(manifest.build)!==217)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b217'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
