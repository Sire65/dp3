...
if(Number(manifest.build)!==239)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b239'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
