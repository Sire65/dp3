...
if(Number(manifest.build)!==192)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b192'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
