...
if(Number(manifest.build)!==86)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b86'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
